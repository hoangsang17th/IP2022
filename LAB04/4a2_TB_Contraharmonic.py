...
if __name__ == "__main__":
    img_nhieu_hat_tieu = cv2.imread('4a2_Anh_nhieu_hat_tieu.tif', 0)
    img_nhieu_muoi = cv2.imread('4a2_Anh_nhieu_muoi.tif', 0)
    ksize =3
    Q1=1.5
    Q2 = -.8
    ...
    fig = plt.figure(figsize=(7, 7))     # Thiết lập vùng (cửa sổ) vẽ
